...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      tags$p("The codes for running this app: ", 
             tags$a(href = "https://github.com/richieyuyongpoh/R-Shiny-Chatbot-", target="_blank", "HERE")
      ),
      ...
      selectInput("model_name", "Model Name",
                  choices = c("gpt-4", "gpt-3.5-turbo-16k"), selected = "gpt-3.5-turbo-16k"),
      tags$hr(),
      sliderInput("temperature", "Temperature", min = 0.1, max = 1.0, value = 0.7, step = 0.1),
      sliderInput("max_length", "Maximum Length", min = 1, max = 16384, value = 4096, step = 4),
      tags$hr(),
